...
function configureTexture( image ) {
    ...
    //Might be needed to flip the image from top to bottom due to the different
    ...
    //Mipmap only works if width and height of texture are a power of 2
...
window.onload = function init() {
    ...
    //Does not work in Chrome due to security restrictions
	//image.src = "SA2011_black.gif";

    //Alt way to get image
    //Does not work in Chrome due to security restrictions
